...
void eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_tl(
    atlas::FieldSet & incFlds, const atlas::FieldSet & stateFlds) {
  oops::Log::trace()
    <<"[eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_tl()] starting ..."
    << std::endl;
  ...
  oops::Log::trace()
    << "[(eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_tl()] ... exit"
    << std::endl;
}
...
void eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_ad(
    atlas::FieldSet & hatFlds, const atlas::FieldSet & stateFlds) {
  oops::Log::trace()
    <<"[eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_ad()] starting ..."
    << std::endl;
  ...
  oops::Log::trace()
    << "[(eval_cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water_inv_ad()] ... exit"
    << std::endl;
}
...
void eval_cloud_ice_mixing_ratio_wrt_dry_air_nl(atlas::FieldSet & stateFlds) {
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_nl()] starting ..."
    << std::endl;
  ...
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_nl()] ... exit"
    << std::endl;
}
...
void eval_cloud_ice_mixing_ratio_wrt_dry_air_tl(
    atlas::FieldSet & incFlds, const atlas::FieldSet & stateFlds) {
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_tl()] starting ..."
    << std::endl;
  ...
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_tl()] ... exit"
    << std::endl;
}
...
void eval_cloud_ice_mixing_ratio_wrt_dry_air_ad(
    atlas::FieldSet & hatFlds, const atlas::FieldSet & stateFlds) {
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_ad()] starting ..."
    << std::endl;
  ...
  oops::Log::trace()
    << "[eval_cloud_ice_mixing_ratio_wrt_dry_air_ad()] ... exit"
    << std::endl;
}
